...
We already have the spatial descriptors written to an object to be used for variance partitioning. However, I would like to take a detour to visualize those descriptors. I use an approach derived from p.XXX of Brocard et al (2019). Interestingly, you can discern the shape of the sampling area fairly well from this map.
